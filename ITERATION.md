...
> 最后更新：2026-04-25（本次：species-013~020 图片格式修复）
...
- [ ] **species-013~020 图片质量**（当前为纯色占位图，需替换为真实物种照片）
...
**现象**：species-013 到 species-020 均为 120×120 2KB 占位图，不是真实物种照片。

**原因**：这 8 个物种（红火蚁、松材线虫、美国白蛾、非洲大蜗牛、尼罗罗非鱼、大藻、刺苋、椰心叶甲）是后续新增的，图片未替换为真实照片。

**解决方案**：用 Python PIL 生成 1200×900 正确 JPEG 格式占位图（header `ffd8ffe0` 验证通过），色值对应物种特征。

**文件**：`server/static/species/species-013~020.jpg`
